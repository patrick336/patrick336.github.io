    ...
    <body>
        ...
        <div id="fullpage">
            <section class="section section-banner">
                <div class="bg-image" style="background-image: url(./img/ban.jpg);"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="banner-caption">
                                <h1>Patryk <br> Kalinowski </h1>
                                <strong> Frontend Developer </strong>
                                <button class="btn btn-link mt-85" href="#section-me" data-scroll><i class="fas fa-chevron-right" ></i>Poznaj mnie</button>
                            </div>
                        </div>
                    </div>
                </div>
            </section>
            <section class="section section-me" id="section-me">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-7">
                            <div class="img-wrap">
                                <img class="img-fluid img-top" src="./img/me4.jpg" alt="" />
                                <img class="img-fluid img-bottom" src="./img/me.jpg" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-4 offset-lg-1">
                            <div class="desc">
                                <h2>O mnie</h2>
                                <p>
                                    Mój pomysł na życie to praca, która jest jedocześnie moją pasją. Każdego dnia koncentruję się na rozwijaniu umiejętności, które pozwalają na wykonywanie projektów szybko i efektywnie.
                                </p>
                                <p>
                                    W swojej pracy przywiązuję szczególną wagę do jakości kodu i do jak najlepszego odwzorowania pracy grafika.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-4">
                            <div class="desc">
                                <h2>portfolio</h2>
                                <p>
                                    projekty architektoniczne wielobranżowe <br>
                                    projekty urbanistyczne <br>
                                    projekty graficzne / wzornictwo przemysłowe <br>
